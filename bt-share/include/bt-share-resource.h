...
/*==============  Image ================= */
#define ICONDIR	tzplatform_mkpath(TZ_SYS_RW_APP,"/org.tizen.bluetooth-share-ui/res/images")
#define BT_ICON_PATH_MAX	256

#define BT_ICON_QP_SEND		strcat(ICONDIR, "/Q02_icon_BT_transmit.png")
#define BT_ICON_QP_RECEIVE	strcat(ICONDIR, "/Q02_icon_BT_transmit.png")
#define BT_ICON_QP_BT_ON	strcat(ICONDIR, "/Q02_icon_BT_transmit.png")
